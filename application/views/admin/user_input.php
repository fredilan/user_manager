    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
		...
		<form id="addUser">
			<div class="form-group">
				...
				<input type="text" class="form-control" name="first_name" id="inputFirstName" placeholder="Enter First Name" required>
			</div>			
			<div class="form-group">
				<label for="inputMiddleName">Middle Name</label>
				<input type="text" class="form-control" name="middle_name" id="inputMiddleName" placeholder="Enter Middle Name">
			</div>			
			<div class="form-group">
				<label for="inputLastName">Last Name</label>
				<input type="text" class="form-control" name="last_name" id="inputLastName" placeholder="Enter Last Name" required>
			</div>			
			<div class="form-group">
				<label for="inputEmailAddress">E-mail Address</label>
				<input type="email" class="form-control" name="email_address" id="inputEmailAddress" placeholder="Enter E-mail Address" required>
			</div>
			<div class="form-group">
				<label for="inputCompany">Company</label>
				<input type="text" class="form-control" name="company" id="inputCompany" placeholder="Enter Company Name" required>
			</div>
			<div class="form-group">
				<label for="inputChannelManager">Channel Manager</label>
				<input type="text" class="form-control" name="channel_manager" id="inputChannelManager" placeholder="Enter Channel Manager" required>
			</div>
			<div class="form-group">
				<label for="inputRates">Rates</label>
				<input type="number" class="form-control" name="rates" id="inputRates" placeholder="Enter Rates">
			</div>
